...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('codestatus.update', [$code->id, $api->id]) }}" method="POST">
                {{ csrf_field() }}
                    ...
                    <div class="box-body" id="headers">
                        ...
                        <div class="row">
                            <div class="form-group col-md-2">
                                ...
                                <input value="{{ $code->code }}" name="code" type="text" class="form-control" placeholder="Access-Token">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Erro</label>
                                <input value="{{ $code->error }}" name="error" type="text" class="form-control" placeholder="Access-Token">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Descricao</label>
                                <textarea name="description" type="text" class="form-control" placeholder="">{{ $code->description }}</textarea>
                            </div>
                        </div>
