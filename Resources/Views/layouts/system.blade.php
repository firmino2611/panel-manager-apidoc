...
<html>
  <head>
    ...
    <link rel="icon" href="{{ asset('public/vendor/apidoc/dist/img/app.jpeg')}}" type="image/x-jpeg" />
    <link rel="icon" href="" type="image/x-jpeg" />
  ...
  |---------------------------------------------------------|
  -->
  <body class="hold-transition {{ config('apidoc.theme.panel') }} {{ implode(' ', config('apidoc.layouts.panel')) }}">
  <div class="wrapper">
    <!-- Main Header -->
    @include('Apidoc::layouts._system._header._index')

    <!-- Left side column. contains the logo and sidebar -->
    @include('Apidoc::layouts._system._sidebar._index')
    ...
    <!-- Main Footer -->
    @include('Apidoc::.layouts._system._footer')
